...
class LocalNotifier {
  ...
  Future<void> _methodCallHandler(MethodCall call) async {
    ...
    // Upstream dereferences this with `!` below, which throws whenever a
    // callback arrives for a notification that is no longer registered — the
    // normal outcome once a caller has released it via `destroy()`, and
    // unavoidable for a caller that releases anything at all. There is nothing
    // left to dispatch, so drop the callback instead of raising.
